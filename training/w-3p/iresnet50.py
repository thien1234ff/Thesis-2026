...
# ✅ thêm iresnet50
from backbones.iresnet import iresnet18, iresnet34, iresnet50, quantize_model
...
FP32_PATH = "/kaggle/input/datasets/hhongeeee/ms1mv2-pretrain/iresnet50.pth"  # ⚠️ phải đúng weight

BATCH_SIZE = 32   # ⚠️ giảm mạnh để tránh OOM
EPOCHS = 30
BASE_LR = 1e-3
BETA = 300
WEIGHT_BIT = 6
...
# =========================================
# LOAD STUDENT (QUANTIZED iresnet50)
# =========================================
...
for epoch in range(EPOCHS):
    ...
    torch.save(student.state_dict(), f"iresnet50_q{WEIGHT_BIT}_epoch{epoch}.pth")
