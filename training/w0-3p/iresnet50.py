...
FP32_PATH = "/kaggle/input/datasets/hhongeeee/pretrain-iresnet50/iresnet50.pth"
...
# iResNet50 embedding size (ArcFace standard)
EMBEDDING_SIZE = 512
...
# =========================================
# LOAD TEACHER (FP32 iResNet50)
# =========================================
teacher = iresnet50(num_features=EMBEDDING_SIZE)
...
# LOAD STUDENT (Q6)
# =========================================
student_fp32 = iresnet50(num_features=EMBEDDING_SIZE)
...
for epoch in range(EPOCHS):
    ...
    print(f"[iResNet50 Q6] Epoch {epoch+1}/{EPOCHS} | "
          f"Loss: {avg_loss:.4f} | Acc: {avg_acc:.4f} | "
          f"TAR: {avg_tar:.4f} | Gap: {gap:.4f}")

    torch.save(student.state_dict(), f"iresnet50_q6_epoch{epoch}.pth")
...
plt.tight_layout()
plt.savefig("iresnet50_training_metrics.png")
plt.show()