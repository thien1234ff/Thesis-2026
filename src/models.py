...
# ============================================================
# iResNet implementation (standard PyTorch FP32 backbones)
# ============================================================
...
class IResNet(nn.Module):
    ...
    def __init__(self, block, layers, dropout=0.0, num_features=512, zero_init_residual=False,
...
def iresnet18(**kwargs):
    return _iresnet(IBasicBlock, [2, 2, 2, 2], **kwargs)


def iresnet34(**kwargs):
    return _iresnet(IBasicBlock, [3, 4, 6, 3], **kwargs)


def iresnet50(**kwargs):
    return _iresnet(IBasicBlock, [3, 4, 14, 3], **kwargs)


def iresnet100(**kwargs):
    return _iresnet(IBasicBlock, [3, 13, 30, 3], **kwargs)
...
class Depth_Wise(nn.Module):
    def __init__(self, in_c, out_c, attention="none", residual=False,
...
class MobileFaceNet(nn.Module):
    def __init__(self, input_size=(112, 112), embedding_size=128, output_name="GDC", attention="none"):
