# ============================================================
# FULL EVAL SCRIPT: FP32 vs Q16 (iResNet-50)
# ============================================================
...
@torch.no_grad()
def extract_embeddings(model, images, batch_size=64, use_flip=True):
    model.eval()
    embeddings = []
...
if __name__ == "__main__":
    ...
    Q16_PATH = os.path.join(PROJECT_ROOT, "weights/w-3p/iresnet50_q6_w3p.pth")

    print("Running evaluation comparison for iResNet-50 (FP32 vs Q6)...")
